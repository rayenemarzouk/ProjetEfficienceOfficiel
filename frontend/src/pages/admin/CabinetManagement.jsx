      ...
      <div className="p-6">
        ...
        <div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-100">
            <h3 className="text-base font-bold text-gray-900">Vue d'ensemble</h3>
          </div>
                ...
                <>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
                    <div className="bg-blue-50 rounded-xl p-4 text-center">
                      ...
                      <p className="text-lg font-bold text-gray-900">{fmt(detailModal.details.dernierMois.ca)} €</p>
                      <p className="text-[10px] text-gray-500 uppercase">CA Dernier Mois</p>
                    </div>
                    <div className="bg-green-50 rounded-xl p-4 text-center">
                      <FiUsers className="w-5 h-5 text-green-600 mx-auto mb-1" />
                      <p className="text-lg font-bold text-gray-900">{detailModal.details.dernierMois.patients}</p>
                      <p className="text-[10px] text-gray-500 uppercase">Patients</p>
                    </div>
                    <div className="bg-purple-50 rounded-xl p-4 text-center">
                      <FiClock className="w-5 h-5 text-purple-600 mx-auto mb-1" />
                      <p className="text-lg font-bold text-gray-900">{detailModal.details.dernierMois.rdv}</p>
                      <p className="text-[10px] text-gray-500 uppercase">Rendez-vous</p>
                    </div>
                    <div className="bg-amber-50 rounded-xl p-4 text-center">
                      <FiTrendingUp className="w-5 h-5 text-amber-600 mx-auto mb-1" />
                      <p className="text-lg font-bold text-gray-900">{detailModal.details.dernierMois.nouveauxPatients}</p>
                      <p className="text-[10px] text-gray-500 uppercase">Nouveaux patients</p>
                    </div>
                  </div>
                        ...
                        {detailModal.details.evolution.slice(-6).map((m, i) => {
                          ...
                          return (
                            <div key={i} className="flex items-center gap-3">
                              <span className="text-xs text-gray-500 w-14">{moisLabel}</span>
