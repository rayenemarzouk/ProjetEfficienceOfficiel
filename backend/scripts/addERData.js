...
async function addERData() {
  try {
    await mongoose.connect(process.env.MONGODB_URI);
    console.log('MongoDB connecté...');

    // Créer le compte ER s'il n'existe pas
    const existingER = await User.findOne({ practitionerCode: 'ER' });
    if (!existingER) {
      await User.create(
        {
        email: 'er@efficience.fr',
        password: 'er@efficience',
        role: 'practitioner',
        name: 'Dr. Emilie Renaud',
        practitionerCode: 'ER',
        cabinetName: 'Cabinet ER',
        isActive: true,
        isVerified: true
      }
    );
      console.log('✅ Compte ER créé.');
    } else {
      console.log('ℹ️ Compte ER déjà présent: ', existingER.email);
    }

    const joursOuvertsER = [
      { praticien: 'ER', mois: '20250101', nbHeures: 0 },
      { praticien: 'ER', mois: '20250201', nbHeures: 3585 },
      { praticien: 'ER', mois: '20250301', nbHeures: 3780 },
      { praticien: 'ER', mois: '20250401', nbHeures: 5040 },
      { praticien: 'ER', mois: '20250501', nbHeures: 5460 },
      { praticien: 'ER', mois: '20250601', nbHeures: 4620 },
      { praticien: 'ER', mois: '20250701', nbHeures: 5460 },
      { praticien: 'ER', mois: '20250801', nbHeures: 4860 },
      { praticien: 'ER', mois: '20250901', nbHeures: 4800 },
      { praticien: 'ER', mois: '20251001', nbHeures: 70 },
      { praticien: 'ER', mois: '20251101', nbHeures: 0 },
      { praticien: 'ER', mois: '20251201', nbHeures: 0 },
      { praticien: 'ER', mois: '20260101', nbHeures: 7140 },
      { praticien: 'ER', mois: '20260201', nbHeures: 5460 },
      { praticien: 'ER', mois: '20260301', nbHeures: 7560 },
      { praticien: 'ER', mois: '20260401', nbHeures: 6300 },
      { praticien: 'ER', mois: '20260501', nbHeures: 5460 },
      { praticien: 'ER', mois: '20260601', nbHeures: 7560 },
      { praticien: 'ER', mois: '20260701', nbHeures: 7140 },
      { praticien: 'ER', mois: '20260801', nbHeures: 7140 },
      { praticien: 'ER', mois: '20260901', nbHeures: 7560 },
      { praticien: 'ER', mois: '20261001', nbHeures: 7140 },
      { praticien: 'ER', mois: '20261101', nbHeures: 6720 },
      { praticien: 'ER', mois: '20261201', nbHeures: 7140 }
    ];

    await AnalyseJoursOuverts.deleteMany({ praticien: 'ER' });
    await AnalyseJoursOuverts.insertMany(joursOuvertsER);
    console.log(`✅ ${joursOuvertsER.length} enregistrements Jours Ouverts ER insérés.`);

    const rdvER = [
      { praticien: 'ER', mois: '20250201', nbRdv: 45, dureeTotaleRdv: 1080, nbPatients: 40, nbNouveauxPatients: 8 },
      { praticien: 'ER', mois: '20250301', nbRdv: 52, dureeTotaleRdv: 1248, nbPatients: 46, nbNouveauxPatients: 10 },
      { praticien: 'ER', mois: '20250401', nbRdv: 65, dureeTotaleRdv: 1560, nbPatients: 58, nbNouveauxPatients: 12 },
      { praticien: 'ER', mois: '20250501', nbRdv: 70, dureeTotaleRdv: 1680, nbPatients: 62, nbNouveauxPatients: 9 },
    ...
    await AnalyseRendezVous.insertMany(rdvER);
    console.log(`✅ ${rdvER.length} enregistrements Rendez-Vous ER insérés.`);

    const realisationER = [
      { praticien: 'ER', mois: '20250201', nbPatients: 40, montantFacture: 16800.00, montantEncaisse: 13400.00 },
      { praticien: 'ER', mois: '20250301', nbPatients: 46, montantFacture: 19300.00, montantEncaisse: 15500.00 },
      { praticien: 'ER', mois: '20250401', nbPatients: 58, montantFacture: 24200.00, montantEncaisse: 19800.00 },
      { praticien: 'ER', mois: '20250501', nbPatients: 62, montantFacture: 25900.00, montantEncaisse: 21200.00 },
      { praticien: 'ER', mois: '20250601', nbPatients: 54, montantFacture: 22600.00, montantEncaisse: 18500.00 },
    ...
    await AnalyseRealisation.deleteMany({ praticien: 'ER' });
    await AnalyseRealisation.insertMany(realisationER);
    console.log(`✅ ${realisationER.length} enregistrements Réalisation ER insérés.`);

    const devisER = [
      { praticien: 'ER', mois: '20250201', nbDevis: 8, montantPropositions: 24000, nbDevisAcceptes: 5, montantAccepte: 15000 },
    ...
    await AnalyseDevis.deleteMany({ praticien: 'ER' });
    await AnalyseDevis.insertMany(devisER);
    console.log(`✅ ${devisER.length} enregistrements Devis ER insérés.`);

    console.log('\n═══════════════════════════════════════');
    console.log('✅ Données ER restaurées avec succès !');
    console.log('═══════════════════════════════════════\n');
